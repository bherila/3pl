 ...
 * @param    *models_pkg.GetNotificationsRequest        request     parameter: Required
 * @return	Returns the *models_pkg.GetNotificationsResponse response from the API call
 */
func (me *NOTIFICATIONS_IMPL) CreateFetchInfoAboutEmailNotificationsSentOnBehalfOfAClient (
            request *models_pkg.GetNotificationsRequest) (*models_pkg.GetNotificationsResponse, error) {
    //the endpoint path uri
    _pathUrl := "/call/getNotifications"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal *models_pkg.GetNotificationsResponse = &models_pkg.GetNotificationsResponse{}
