...
{
    public class ParcelCheckWeightGoodResponse : BaseModel 
    {
        // These fields hold the values for the public properties.
        private Models.Status3Enum? status;
        private Models.Results3 results;
        private List<Models.GenericError> errors;

        /// <summary>
        /// The status of the call.
        /// * `success` - The parcel weight is withing acceptable tolerance
        /// </summary>
        [JsonProperty("status", ItemConverterType = typeof(StringValuedEnumConverter))]
        public Models.Status3Enum? Status 
        { 
            get 
            {
                return this.status; 
        ...
        public Models.Results3 Results 
        { 
            get 
            {
                return this.results; 
